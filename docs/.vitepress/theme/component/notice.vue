...
setTimeout(function () { visible.value = false }, 12000);
</script>
...
<template>
    ...
    <div v-if="visible" class="notice">
        ...
        <div class="notice-describe">
            <!-- <p></p> -->
            <p>推荐流量卡：192G 全网通用流量！</p>
            <p class="notice-domain">
                <strong>
                    QQ频道号：<a href="https://vitepress.yiov.top/layout.html#%E5%85%AC%E5%91%8A"
                        target="_blank">pd13836025</a>
                </strong>
            </p>
        
            <img class="notice-img" src="../../../public/qrcode.jpg">
        </div>
