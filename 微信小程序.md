...
![image-20220531173643489](C:\Users\86138\AppData\Roaming\Typora\typora-user-images\image-20220531173643489.png)
...
- 绑定事件方式
  ...
  - ```html
    ...
    <view bindtap="事件名">hello word！</view>
    ```
...
- ![image-20220621001040706](C:\Users\86138\AppData\Roaming\Typora\typora-user-images\image-20220621001040706.png)
...
- ![image-20220531194349625](C:\Users\86138\AppData\Roaming\Typora\typora-user-images\image-20220531194349625.png)
...
- ```js
  ...
  <view wx:for="{{lis}}" wx:key='index' wx:for-item='aidou'  wx:for-index='idx'>
     {{idx}} -- {{aidou}}
  </view>
...
1. ![image-20220621142818163](C:\Users\86138\AppData\Roaming\Typora\typora-user-images\image-20220621142818163.png)
...
1. 从当前小程序跳转到另外一个小程序
   ...
   3. 该API需要传递另外一个小程序的appid,才可以实现跳转
      ...
      ![image-20220621182525150](C:\Users\86138\AppData\Roaming\Typora\typora-user-images\image-20220621182525150.png)
...
![image-20220622194828735](C:\Users\86138\AppData\Roaming\Typora\typora-user-images\image-20220622194828735.png)

![image-20220622194924395](C:\Users\86138\AppData\Roaming\Typora\typora-user-images\image-20220622194924395.png)
...
![image-20220623002613606](C:\Users\86138\AppData\Roaming\Typora\typora-user-images\image-20220623002613606.png)
