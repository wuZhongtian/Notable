...
- 对于不小心已经存入 git仓库的忽略文件需要做三步操作，具体看第5部分（配置忽略文件）。
...
![image-20210911220445110](C:\Users\wzt\AppData\Roaming\Typora\typora-user-images\image-20210911220445110.png)



### .git 目录 

- hooks 目录 ：包含客户端或服务器的钩子脚本，在特定操作下自动执行。类似于 JS事件，自动执行。
...
- 所有的工作不要直接在主分支上进行操作
  ...
  - 在自己创建的分支上进行开发
- **每次提交代码到远端仓库时都必须先将远端仓库更新pull 到本地，保证不存在差异代码。**
...
![image-20210916211640409](C:\Users\wzt\AppData\Roaming\Typora\typora-user-images\image-20210916211640409.png)
